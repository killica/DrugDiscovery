...
\begin{tabular}{|c|c|c|}
\hline
\textbf{Молекул} & \textbf{Рационална структурна формула} & \textbf{SMILES} \\
\hline

Етанол &
\includegraphics[height=1.6cm]{slike/Etanol.png} &
\texttt{CCO} \\
\hline

Етен &
\includegraphics[height=1.6cm]{slike/Eten.png} &
\texttt{C=C} \\
\hline

Изобутан &
\includegraphics[height=1.6cm]{slike/Izobutan.png} &
\texttt{CC(C)C} \\
\hline

Бензен &
\includegraphics[height=1.6cm]{slike/Benzen.png} &
\texttt{c1ccccc1} \\
\hline
